...
#define TFT_CS   GPIO_NUM_15  // YP, Chip select control pin (library pulls permanently low 
#define TFT_DC   GPIO_NUM_4  // XM, Data Command control pin - use a pin in the range 0-31
#define TFT_RST  GPIO_NUM_17  // Reset pin, toggles on startup

#define TFT_WR    GPIO_NUM_2  // Write strobe control pin - use a pin in the range 0-31
#define TFT_RD    GPIO_NUM_16  // Read strobe control pin  - use a pin in the range 0-31

#define TFT_D0   GPIO_NUM_12  // XP, Must use pins in the range 0-31 for the data bus
#define TFT_D1   GPIO_NUM_13  // YM, so a single register write sets/clears all bits.
#define TFT_D2   GPIO_NUM_19  // Pins can be randomly assigned, this does not affect
#define TFT_D3   GPIO_NUM_18  // TFT screen update performance.
#define TFT_D4   GPIO_NUM_25
#define TFT_D5   GPIO_NUM_26
#define TFT_D6   GPIO_NUM_27
#define TFT_D7   GPIO_NUM_14
