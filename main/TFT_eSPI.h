...
class TFT_eSPI{
 ...
 public:
  ...
  void     reinit(uint8_t tc = TAB_COLOUR); // Same - begi
  ...
  int16_t  drawNumber(long long_num,int poX, int poY, int font),
           ...
           // Handle String type
    drawString(const std::string& string, int poX, int poY, int font),
           drawString(const std::string& string, int poX, int poY),
           drawCentreString(const std::string& string, int dX, int poY, int font), // Deprecated, use setTextDatum() and drawString()
    drawRightString(const std::string& string, int dX, int poY, int font);  // Deprecated, use setTextDatum() and drawString()

  int16_t  textWidth(const char *string, int font),
           textWidth(const char *string),
    textWidth(const std::string& string, int font),
